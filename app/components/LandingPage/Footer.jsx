  ...
  return (
    <div className=" bg-[#F1F1F1] py-14">
      <div className="container">
        <div className="main">
          <section className=" border-b-2 border-[#676869] py-10 flex flex-col gap-7 items-center md:flex-row md:justify-between ">
            <div className="footer_head">
              ...
              />
              <p>
                With GoTechy platform, you can learn the best IT skills with
                free mentorship
              </p>
            </div>

            <div className="footer_links quick_links">
              <h1>Quick Links</h1>
              <Link href="/">Home</Link>
            ...
            <div className="footer_links footer_courses">
              <h1>Available Courses</h1>
              <Link href="/">UI/UX Design</Link>
              <Link href="/">Fullstack JavaScript</Link>
              <Link href="/">Frontend Development</Link>
            </div>

            <div className="footer_links footer_policy">
              <h1>Policies</h1>
          ...
          <section className="flex flex-col-reverse gap-4 items-center mt-10 md:flex-row md:justify-between">
